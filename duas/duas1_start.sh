...
DU_NODE=${DU_NODE:-docker_node1}
DU_HOST=${DU_HOST:-duas1}
DU_IOPORT=${DU_IOPORT:-10600}
...
echo "[${container_name}] Starting duas1..."
./unistart

echo "[${container_name}] Started - container duas1 running..."
tail -f /dev/null
